            ...
            <tr v-for="product of products.data">
                ...
                <td class="p-2 border-b-2">
                    <Menu as="div" class="relative inline-block text-left">
                        <div>
                            <MenuButton
                                class="inline-flex justify-center w-full p-1 text-sm font-medium rounded-full bg-none hover:bg-black/30 active:bg-black/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75"
                            >
                        ...
                        >
                            <MenuItems
                                class="z-[10] absolute right-0 mt-2 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none"
                            >
                                <div class="p-2">
